...
export class BordereauLivraisonService {
  ...
  public supprimerBordereauLivraisonById(identifiantBordereauLivraison: string): Observable<CustomHttpRespone> {
    return this.httpClient.delete<CustomHttpRespone>(`${this.urlServeur}/SupprimerBordereauLivraisonById/${identifiantBordereauLivraison}`, { withCredentials: true });
  }
